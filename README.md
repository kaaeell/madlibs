...
## What it does
- Picks a random story from 6 different ones (or you can choose!)
...
- You can save your story to a text file
...
- [x] Add more stories
- [x] Let user choose a story instead of random
- [x] Save the generated story to a text file
